...
## Roadmap
The Wizard w2 evolution plan lives at `docs/wizard-evolution-spec.md` — read it before starting any milestone work. Upgrading an existing w1 install: `docs/wizard-w1-to-w2-migration.md`.
