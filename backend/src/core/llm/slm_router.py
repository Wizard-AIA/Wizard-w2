...
class SLMRouter:
    ...
    _METADATA_MARKERS = ["schema", "column", "preview", "dataset info", "data type", "head", "tail", "first", "last"]

    _CHITCHAT_MARKERS = ["hello", "hi", "hey", "thanks", "thank you", "bye", "good morning"]

    _LIGHTWEIGHT_MARKERS = ["mean", "count", "min", "max", "average", "sum", "how many", "size", "dimensions"]
